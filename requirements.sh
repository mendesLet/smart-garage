...
/snap/bin/cmake -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=$DARKHELP_INSTALL_PATH ..
make -j$(nproc)
...
sudo apt-get install -y build-essential libtclap-dev libmagic-dev libopencv-dev
